...
declare class TimelineLite extends SimpleTimeline {
    ...
    /** Adds a tween, timeline, callback, or label (or an array of them) to the timeline. */
    append(value:any, offsetOrLabel?:any): TimelineLite;

    /** Adds a tween, timeline, callback, or label (or an array of them) to the timeline. */
    insert(value: any, position?: any, align?: string, stagger?: number):TimelineLite;
    ...
    /** Seamlessly transfers all tweens, timelines, and [optionally] delayed calls from the root timeline into a new TimelineLite so that you can perform advanced tasks on a seemingly global basis without affecting tweens/timelines that you create after the declare. */
    static declareRoot(vars?: {}, omitDelayedCalls?: boolean): TimelineLite;
